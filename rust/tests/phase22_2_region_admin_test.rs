...
async fn test_show_region_api() -> Result<()> {
    ...
    let response = config
        ...
        .get(&format!(
            "{}/admin/regions/{}",
            config.api_base_url, "ShowTestRegion"
        ))
        .header("X-API-Key", &config.api_key)
        .send()
        .await?;
...
async fn test_update_region_api() -> Result<()> {
    ...
    let response = config
        ...
        .put(&format!(
            "{}/admin/regions/{}",
            config.api_base_url, "UpdateTestRegion"
        ))
        .header("X-API-Key", &config.api_key)
        .header("Content-Type", "application/json")
        .json(&update_payload)
...
async fn test_delete_region_api() -> Result<()> {
    ...
    let response = config
        ...
        .delete(&format!(
            "{}/admin/regions/{}",
            config.api_base_url, "DeleteTestRegion"
        ))
        .header("X-API-Key", &config.api_key)
        .send()
        .await?;
...
async fn test_region_lifecycle() -> Result<()> {
    ...
    let show_response = config
        ...
        .get(&format!(
            "{}/admin/regions/{}",
            config.api_base_url, test_region_name
        ))
        .header("X-API-Key", &config.api_key)
        .send()
        .await?;
