...
fn generate_inventory_skeleton(agent_id: &str) -> String {
    ...
    let folders = vec![
        ("My Inventory", "00000000-0000-0000-0000-000000000000", 8, 19),
...
fn generate_library_skeleton() -> String {
    let folders = vec![
        ("OpenSim Library", "00000000-0000-0000-0000-000000000000", "00000112-000f-0000-0000-000100bba000", 8, 429),
        ("Animations Library", "00000112-000f-0000-0000-000100bba000", "f0908f10-b9bf-11dc-95ff-0800200c9a66", 20, 1),
        ("BodyParts Library", "00000112-000f-0000-0000-000100bba000", "d499e5e0-b9bf-11dc-95ff-0800200c9a66", 13, 1),
        ("Clothing Library", "00000112-000f-0000-0000-000100bba000", "b75056e0-b9bf-11dc-95ff-0800200c9a66", 5, 1),
        ("Gestures Library", "00000112-000f-0000-0000-000100bba000", "8e1e3a30-b9bf-11dc-95ff-0800200c9a66", 21, 1),
        ("Landmarks Library", "00000112-000f-0000-0000-000100bba000", "6bcd48e0-b9bf-11dc-95ff-0800200c9a66", 3, 1),
        ("Notecards Library", "00000112-000f-0000-0000-000100bba000", "33cbd240-b9bf-11dc-95ff-0800200c9a66", 7, 1),
        ("Objects Library", "00000112-000f-0000-0000-000100bba000", "1576c6b0-b9bf-11dc-95ff-0800200c9a66", 6, 1),
        ("Photos Library", "00000112-000f-0000-0000-000100bba000", "cf7e2db0-b9be-11dc-95ff-0800200c9a66", 15, 1),
        ("Scripts Library", "00000112-000f-0000-0000-000100bba000", "30000112-000f-0000-0000-000100bba002", 10, 1),
        ("Sounds Library", "00000112-000f-0000-0000-000100bba000", "c1284980-b9be-11dc-95ff-0800200c9a66", 1, 1),
        ("Texture Library", "00000112-000f-0000-0000-000100bba000", "00000112-000f-0000-0000-000100bba001", 0, 1),
        ("Settings Library", "00000112-000f-0000-0000-000100bba000", "00000112-000f-0000-0000-000100bba025", 56, 4),
    ];
