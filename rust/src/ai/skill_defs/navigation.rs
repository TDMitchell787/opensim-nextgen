...
static P_REGION: ParamDef = ParamDef {
    name: "region",
...
static P_POSITION: ParamDef = ParamDef {
    ...
    required: false,
    default_value: Some("[128.0, 128.0, 25.0]"),
...
static P_LANDMARK_ID: ParamDef = ParamDef {
    name: "landmark_id",
    param_type: ParamType::Uuid,
    required: true,
    default_value: None,
    description: "Landmark inventory item ID",
};
static P_TOUR_NAME: ParamDef = ParamDef {
    name: "tour_name",
    param_type: ParamType::String,
    required: true,
    default_value: None,
...
pub static TELEPORT_AGENT: SkillDef = SkillDef {
    ...
    phase: "Phase 203.7",
    tags: &["navigation", "teleport", "movement"],
    examples: &[],
};
...
pub static CREATE_LANDMARK: SkillDef = SkillDef {
    ...
    phase: "Phase 203.7",
    tags: &["navigation", "landmark", "location"],
    examples: &[],
};
...
pub static GIVE_LANDMARK: SkillDef = SkillDef {
    ...
    maturity: SkillMaturity::L3Functional,
    phase: "Phase 203.7",
    tags: &["navigation", "landmark", "give"],
    examples: &[],
};

pub static CREATE_WAYPOINT_TOUR: SkillDef = SkillDef {
    id: "create_waypoint_tour",
    domain: SkillDomain::Navigation,
    display_name: "Create Waypoint Tour",
    ...
    maturity: SkillMaturity::L3Functional,
    phase: "Phase 203.7",
    tags: &["navigation", "tour", "waypoint"],
    examples: &[],
};

pub static START_GUIDED_TOUR: SkillDef = SkillDef {
    id: "start_guided_tour",
    domain: SkillDomain::Navigation,
    display_name: "Start Guided Tour",
...
pub static MAP_POI: SkillDef = SkillDef {
    id: "map_poi",
    domain: SkillDomain::Navigation,
    display_name: "Map Points of Interest",
    ...
    maturity: SkillMaturity::L3Functional,
    phase: "Phase 203.7",
    tags: &["navigation", "map", "discovery"],
    examples: &[],
};

pub static SET_HOME_LOCATION: SkillDef = SkillDef {
    id: "set_home_location",
    domain: SkillDomain::Navigation,
    display_name: "Set Home Location",
