...
static P_RECIPE: ParamDef = ParamDef {
    name: "recipe",
    param_type: ParamType::Enum(&["car", "bike", "plane", "vtol", "vessel", "starship", "lani"]),
    required: true,
    default_value: None,
    description: "Vehicle recipe type",
};
static P_POSITION: ParamDef = ParamDef {
    ...
    required: true,
    default_value: None,
    description: "Build position [x, y, z]",
};
static P_TUNING: ParamDef = ParamDef {
    name: "tuning",
    param_type: ParamType::F32Map,
    required: false,
    default_value: None,
    description: "Tuning parameter overrides (e.g. MAX_SPEED, TURN_RATE)",
};
static P_ROOT_ID: ParamDef = ParamDef {
    ...
    required: true,
    default_value: None,
    description: "Vehicle root prim local ID",
};
