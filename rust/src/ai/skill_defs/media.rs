...
static P_SCENE_NAME: ParamDef = ParamDef {
    name: "scene_name", param_type: ParamType::String, required: true,
    default_value: None, description: "Scene or composition name",
};
static P_DESCRIPTION: ParamDef = ParamDef {
    name: "description", param_type: ParamType::String, required: true,
    default_value: None, description: "Creative description",
};
static P_TITLE: ParamDef = ParamDef {
    name: "title", param_type: ParamType::String, required: true,
    default_value: None, description: "Title for the composition",
};
static P_BOARD_NAME: ParamDef = ParamDef {
    name: "board_name", param_type: ParamType::String, required: true,
    default_value: None, description: "Advertisement board name",
};
static P_SUBJECT_POS: ParamDef = ParamDef {
    name: "subject_position", param_type: ParamType::Vec3, required: true,
    default_value: None, description: "Subject position [x, y, z]",
};
static P_CAMERA_ANGLE: ParamDef = ParamDef {
    name: "camera_angle", param_type: ParamType::String, required: false,
    default_value: Some("eye_level"), description: "Camera angle preset",
};
static P_COMPOSITION: ParamDef = ParamDef {
    name: "composition", param_type: ParamType::String, required: false,
    default_value: Some("rule_of_thirds"), description: "Composition style",
};
static P_LIGHTING: ParamDef = ParamDef {
    name: "lighting", param_type: ParamType::String, required: false,
    default_value: Some("natural"), description: "Lighting preset",
};
static P_DOF: ParamDef = ParamDef {
    name: "depth_of_field", param_type: ParamType::F32, required: false,
    default_value: Some("2.0"), description: "Depth of field (f-stop)",
};
static P_NAME: ParamDef = ParamDef {
    name: "name", param_type: ParamType::String, required: true,
    default_value: None, description: "Output name",
};
static P_SHOT_TYPE: ParamDef = ParamDef {
    name: "shot_type", param_type: ParamType::String, required: true,
    default_value: None, description: "Shot type (orbit, follow, dolly, crane)",
};
static P_SPEED: ParamDef = ParamDef {
    name: "speed", param_type: ParamType::F32, required: false,
    default_value: Some("1.0"), description: "Camera movement speed multiplier",
};
static P_PRESET: ParamDef = ParamDef {
    name: "preset", param_type: ParamType::String, required: false,
    default_value: None, description: "Quality/style preset",
};
static P_SIZE: ParamDef = ParamDef {
    name: "size", param_type: ParamType::String, required: false,
    default_value: Some("1920x1080"), description: "Output resolution",
};
static P_QUALITY: ParamDef = ParamDef {
    name: "quality", param_type: ParamType::String, required: false,
    default_value: Some("high"), description: "Render quality level",
};
static P_EFFECTS: ParamDef = ParamDef {
    name: "effects", param_type: ParamType::StringArray, required: false,
    default_value: None, description: "Post-processing effects list",
};
static P_DURATION: ParamDef = ParamDef {
    name: "duration", param_type: ParamType::F32, required: true,
    default_value: None, description: "Video duration in seconds",
};
static P_FPS: ParamDef = ParamDef {
    name: "fps", param_type: ParamType::U32, required: false,
    default_value: Some("30"), description: "Frames per second",
};
static P_SKILL_ID: ParamDef = ParamDef {
    name: "skill_id", param_type: ParamType::String, required: true,
    default_value: None, description: "Skill ID to generate tutorial for",
};
static P_STYLE: ParamDef = ParamDef {
    name: "style", param_type: ParamType::String, required: false,
    default_value: Some("standard"), description: "Tutorial style (standard, quick, detailed)",
};
static P_LANGUAGE: ParamDef = ParamDef {
    name: "language", param_type: ParamType::String, required: false,
    default_value: Some("en"), description: "Language code for narration",
};
static P_CAMERA_STYLE: ParamDef = ParamDef {
    name: "camera_style", param_type: ParamType::String, required: false,
    default_value: Some("orbit"), description: "Camera capture style",
};
static P_SCRIPT_ID: ParamDef = ParamDef {
    name: "script_id", param_type: ParamType::String, required: true,
    default_value: None, description: "Tutorial script ID",
};
static P_VOICE: ParamDef = ParamDef {
    name: "voice", param_type: ParamType::String, required: false,
    default_value: Some("en_US-lessac-medium"), description: "TTS voice identifier",
};
static P_FOOTAGE_PATH: ParamDef = ParamDef {
    name: "footage_path", param_type: ParamType::String, required: true,
    default_value: None, description: "Path to captured footage",
};
static P_NARRATION_PATH: ParamDef = ParamDef {
    name: "narration_path", param_type: ParamType::String, required: true,
    default_value: None, description: "Path to TTS audio file",
};
static P_VIDEO_PATH: ParamDef = ParamDef {
    name: "video_path", param_type: ParamType::String, required: true,
    default_value: None, description: "Path to video file",
};
static P_TIMESTAMP: ParamDef = ParamDef {
    name: "timestamp", param_type: ParamType::F32, required: false,
    default_value: Some("5.0"), description: "Video timestamp for thumbnail",
};
static P_DOMAIN_FILTER: ParamDef = ParamDef {
    name: "domain_filter", param_type: ParamType::String, required: false,
    default_value: None, description: "Filter by domain (or all if omitted)",
};
static P_FORCE_REGEN: ParamDef = ParamDef {
    name: "force_regen", param_type: ParamType::Bool, required: false,
    default_value: Some("false"), description: "Force regeneration of existing tutorials",
};
...
pub static COMPOSE_PHOTO: SkillDef = SkillDef {
    ...
    params: &[P_SUBJECT_POS, P_CAMERA_ANGLE, P_COMPOSITION, P_LIGHTING, P_DOF, P_NAME],
    returns: ReturnType::LocalIds,
    requires_region: true, requires_agent: true, requires_admin: false,
    maturity: SkillMaturity::L7Production,
    phase: "Phase 170",
...
pub static DRONE_CINEMATOGRAPHY: SkillDef = SkillDef {
    ...
    params: &[P_SCENE_NAME, P_SHOT_TYPE, P_SUBJECT_POS, P_SPEED, P_LIGHTING],
    returns: ReturnType::LocalIds,
    requires_region: true, requires_agent: true, requires_admin: false,
    maturity: SkillMaturity::L7Production,
    phase: "Phase 160",
...
pub static LUXOR_SNAPSHOT: SkillDef = SkillDef {
    ...
    params: &[P_PRESET, P_SIZE, P_QUALITY, P_EFFECTS, P_LIGHTING, P_SUBJECT_POS, P_NAME],
    returns: ReturnType::Success,
    requires_region: true, requires_agent: true, requires_admin: false,
    maturity: SkillMaturity::L7Production,
    phase: "Phase 171",
...
pub static LUXOR_VIDEO: SkillDef = SkillDef {
    ...
    params: &[P_SHOT_TYPE, P_DURATION, P_FPS, P_SIZE, P_QUALITY, P_EFFECTS, P_LIGHTING, P_SUBJECT_POS, P_NAME],
    returns: ReturnType::Success,
    requires_region: true, requires_agent: true, requires_admin: false,
    maturity: SkillMaturity::L7Production,
    phase: "Phase 172",
...
pub static PUBLISH_TUTORIAL: SkillDef = SkillDef {
    ...
    returns: ReturnType::Success,
    requires_region: false, requires_agent: true, requires_admin: true,
    maturity: SkillMaturity::L0Seed,
    phase: "Phase 209",
