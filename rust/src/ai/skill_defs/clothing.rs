...
static P_TARGET_AGENT: ParamDef = ParamDef {
    ...
    required: true,
    default_value: None,
    description: "Agent to receive the garment",
};
static P_LOGO_PATH: ParamDef = ParamDef {
    ...
    required: false,
    default_value: None,
    description: "Path to logo image for the shirt",
};
static P_SHIRT_COLOR: ParamDef = ParamDef {
    name: "shirt_color",
    param_type: ParamType::Vec4,
    required: false,
    default_value: Some("[255, 255, 255, 255]"),
    description: "RGBA color bytes",
};
static P_FRONT_OFFSET: ParamDef = ParamDef {
    name: "front_offset_inches",
    param_type: ParamType::F32,
    required: false,
    default_value: Some("4.0"),
    description: "Logo offset from center in inches",
};
static P_BACK_OFFSET: ParamDef = ParamDef {
    name: "back_offset_inches",
    param_type: ParamType::F32,
    required: false,
    default_value: None,
    description: "Back logo offset (None = no back logo)",
};
static P_SLEEVE_LENGTH: ParamDef = ParamDef {
    ...
    description: "Sleeve length 0.0 (tank) to 1.0 (full)",
};
static P_FIT: ParamDef = ParamDef {
    name: "fit",
    param_type: ParamType::Enum(&["tight", "regular", "loose"]),
    required: false,
    default_value: Some("regular"),
    description: "Garment fit",
};
static P_COLLAR: ParamDef = ParamDef {
    name: "collar",
    param_type: ParamType::Enum(&["crew", "v-neck", "scoop"]),
    required: false,
    default_value: Some("crew"),
    description: "Collar style",
};
static P_GARMENT_NAME: ParamDef = ParamDef {
    name: "name",
    param_type: ParamType::String,
    required: false,
    default_value: Some("Custom T-Shirt"),
...
static P_COLOR: ParamDef = ParamDef {
    ...
    required: false,
    default_value: Some("[255, 255, 255, 255]"),
    description: "Garment color RGBA",
};
static P_STYLE: ParamDef = ParamDef {
    ...
    description: "Garment style variant",
};
static P_LENGTH: ParamDef = ParamDef {
    ...
    description: "Garment length 0.0-1.0",
};
static P_TYPE: ParamDef = ParamDef {
    ...
    required: true,
    default_value: None,
    description: "Accessory type (hat, glasses, belt, etc.)",
};
