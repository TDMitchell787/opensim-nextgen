...
static P_TOPIC: ParamDef = ParamDef {
    name: "topic",
...
static P_MESSAGE: ParamDef = ParamDef {
    ...
    required: true,
    default_value: None,
    description: "Hint or info text",
};
static P_HIGHLIGHT: ParamDef = ParamDef {
    name: "highlight_object",
    param_type: ParamType::U32,
    required: false,
    default_value: None,
    description: "Local ID of object to highlight",
};
...
static P_BODY: ParamDef = ParamDef {
    name: "body_text",
    param_type: ParamType::String,
    required: true,
    default_value: None,
...
static P_STYLE: ParamDef = ParamDef {
    name: "style",
    param_type: ParamType::Enum(&["minimal", "standard", "elaborate"]),
    required: false,
    default_value: Some("standard"),
    description: "Welcome area style",
};
static P_STEP: ParamDef = ParamDef {
    name: "step",
    param_type: ParamType::U32,
    required: true,
    default_value: None,
    description: "Tutorial step number",
};

pub static START_TUTORIAL: SkillDef = SkillDef {
    id: "start_tutorial",
    domain: SkillDomain::Tutorial,
    display_name: "Start Tutorial",
...
pub static SHOW_HINT: SkillDef = SkillDef {
    ...
    maturity: SkillMaturity::L3Functional,
    phase: "Phase 209.11",
    tags: &["tutorial", "hint", "help"],
    examples: &[],
};

pub static CREATE_INFO_BOARD: SkillDef = SkillDef {
    id: "create_info_board",
    domain: SkillDomain::Tutorial,
    display_name: "Create Info Board",
    ...
    maturity: SkillMaturity::L3Functional,
    phase: "Phase 209.11",
    tags: &["tutorial", "info", "signage"],
    examples: &[],
};

pub static CREATE_WELCOME_AREA: SkillDef = SkillDef {
    id: "create_welcome_area",
    domain: SkillDomain::Tutorial,
    display_name: "Create Welcome Area",
    ...
    maturity: SkillMaturity::L3Functional,
    phase: "Phase 209.11",
    tags: &["tutorial", "welcome", "environment"],
    examples: &[],
};
...
pub static TRACK_PROGRESS: SkillDef = SkillDef {
    id: "track_progress",
    domain: SkillDomain::Tutorial,
    display_name: "Track Tutorial Progress",
    ...
    maturity: SkillMaturity::L3Functional,
    phase: "Phase 209.11",
    tags: &["tutorial", "progress", "tracking"],
    examples: &[],
};
