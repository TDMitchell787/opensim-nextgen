...
static P_PRESET: ParamDef = ParamDef {
    name: "preset", param_type: ParamType::String, required: true,
    default_value: None, description: "Terrain preset name (island, mountains, mesa, etc.)",
};
static P_SEED: ParamDef = ParamDef {
    name: "seed", param_type: ParamType::U32, required: false,
    default_value: None, description: "Random seed for reproducibility",
};
static P_SCALE: ParamDef = ParamDef {
    name: "scale", param_type: ParamType::F32, required: false,
    default_value: Some("1.0"), description: "Height scale multiplier",
};
static P_ROUGHNESS: ParamDef = ParamDef {
    name: "roughness", param_type: ParamType::F32, required: false,
    default_value: None, description: "Terrain roughness factor",
};
static P_WATER_LEVEL: ParamDef = ParamDef {
    name: "water_level", param_type: ParamType::F32, required: false,
    default_value: None, description: "Water height in meters",
};
static P_REGION_ID: ParamDef = ParamDef {
    name: "region_id", param_type: ParamType::String, required: false,
    default_value: None, description: "Target region ID or name",
};
static P_GRID_SIZE: ParamDef = ParamDef {
    name: "grid_size", param_type: ParamType::U32, required: false,
    default_value: None, description: "Multi-region grid size",
};
static P_GRID_X: ParamDef = ParamDef {
    name: "grid_x", param_type: ParamType::U32, required: false,
    default_value: None, description: "Grid X coordinate",
};
static P_GRID_Y: ParamDef = ParamDef {
    name: "grid_y", param_type: ParamType::U32, required: false,
    default_value: None, description: "Grid Y coordinate",
};
static P_FILE_PATH: ParamDef = ParamDef {
    name: "file_path", param_type: ParamType::String, required: true,
    default_value: None, description: "Path to terrain file",
};
static P_HEIGHT_MIN: ParamDef = ParamDef {
    name: "height_min", param_type: ParamType::F32, required: false,
    default_value: Some("0.0"), description: "Minimum height mapping",
};
static P_HEIGHT_MAX: ParamDef = ParamDef {
    name: "height_max", param_type: ParamType::F32, required: false,
    default_value: Some("100.0"), description: "Maximum height mapping",
};
static P_PREVIEW_ID: ParamDef = ParamDef {
    name: "preview_id", param_type: ParamType::String, required: true,
    default_value: None, description: "Preview session ID to apply or reject",
};
...
pub static TERRAIN_GENERATE: SkillDef = SkillDef {
    ...
    params: &[P_PRESET, P_SEED, P_SCALE, P_ROUGHNESS, P_WATER_LEVEL, P_REGION_ID, P_GRID_SIZE, P_GRID_X, P_GRID_Y],
