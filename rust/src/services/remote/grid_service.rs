...
impl GridServiceTrait for RemoteGridService {
    ...
    async fn get_region_by_uuid(
        ...
        debug!(
            "Remote: Getting region by UUID: {} (scope: {})",
            region_id, scope_id
        );
    ...
    async fn get_region_by_name(&self, scope_id: Uuid, name: &str) -> Result<Option<RegionInfo>> {
        debug!(
            "Remote: Getting region by name: {} (scope: {})",
            name, scope_id
        );
    ...
    async fn get_region_by_position(
        ...
        debug!(
            "Remote: Getting region by position: ({}, {}) (scope: {})",
            x, y, scope_id
        );
    ...
    async fn get_neighbours(
        ...
        debug!(
            "Remote: Getting neighbours for region: {} (range: {})",
            region_id, range
        );
    ...
    async fn get_regions(&self, scope_id: Uuid, flags: u32) -> Result<Vec<RegionInfo>> {
        debug!(
            "Remote: Getting regions with flags: {} (scope: {})",
            flags, scope_id
        );
